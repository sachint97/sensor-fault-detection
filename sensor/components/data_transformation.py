...
class DataTransformation:
    ...
    def get_data_transformer_object(cls) -> Pipeline:
        ...
        try:
            ...
            robust_scaler = RobustScaler() #keep every feature in same range and handle outlies

            simple_imputer = SimpleImputer(strategy="constant", fill_value=0) #populate missing values with zero's
